...
st.title("⚡ CyberChat Premium AI")
st.error("🚨 **ВАЖНОЕ ПРАВИЛО:** Делай паузу в 5-10 секунд перед каждым новым вопросом! Если писать слишком часто, робот временно заблокируется.")
